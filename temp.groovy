...
preferences {
    ...
    page(name: "setupOpenWeather", nextPage: "mainPage")
}
...
def setupOpenWeather(){
    ...
    if (childDevice) {
       childDevice.setupDevice(latitude: 38.747204, longitude: -77.700539, apiKey: "f06d50f56deb8cfa989bf122cac36693", pollInterval: '10 Minutes');
       childDevice.pollData();
        
    }
    
    dynamicPage(name: "Nothing"){
        section {
            paragraph "Hello"
        }
    }
